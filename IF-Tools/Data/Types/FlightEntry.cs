...
namespace IFTools.Data.Types
{
    public class FlightEntry
    {
        ...
        public async Task<FlightPlanEntry> GetFlightPlan(InfiniteFlightApi apiService, Guid sessionId)
        {
            var flightPlans = await apiService.GetFlightPlansAsync(sessionId);
